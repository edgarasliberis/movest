...
As we see from the data, the reversion technique classifier starts being effective at 50--60\% capacity setting and $\chi^2$ attack is only effective starting at YY\%.
